...
const About = () => {
  ...
  // Text Variables
  const title = "Texas Qazaq Foundation";
  const description =
    "Texas Qazaq Foundation is dedicated to bringing together members of the community to celebrate, support, and promote Kazakh culture, traditions, and values. We aim to foster a sense of belonging and provide a platform for everyone to stay connected and contribute to our vibrant community.";
  ...
  const involvementDescription =
    "Join us in our journey of promoting and celebrating the rich cultural heritage of Kazakhstan. Whether you're looking to volunteer, participate in events, or just connect with like-minded individuals, Texas Qazaq Foundation welcomes you!";
  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto bg-gray-100 rounded-lg px-5 py-10">
        ...
        {/* Content */}
        <p className="text-md mx-2 lg:text-lg text-center mb-8">
          {description}
        </p>
