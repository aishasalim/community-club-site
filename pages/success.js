    ...
    <div className="flex flex-col justify-center items-center min-h-screen bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-12">
      <div className="bg-white shadow-lg rounded-lg p-8 max-w-lg text-center">
        <h1 className="text-4xl font-extrabold text-black mb-6">
          Thank You for Joining the Texas Qazaq Foundation Mailing List!
        </h1>
        <p className="mt-4 text-lg text-gray-700">
          We're excited to have you with us. Stay tuned for updates, events, and
          more.
        </p>
        <p className="mt-4 text-lg text-gray-700">
          We recommend you to join our WhatsApp chat where all the
          communications and discussions happen.
        </p>
        ...
        >
          <WhatsappIcon height="24px" width="24px" className="mr-2" />{" "}
